...
export function PhoneIcon({ className = "size-5" }: IconProps) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.338c0-1.37.94-2.57 2.281-2.818l1.12-.205A2.25 2.25 0 0 1 7.832 4.77l.782 1.953a2.25 2.25 0 0 1-.516 2.485L7.05 10.24a.75.75 0 0 0-.142.759c.49 1.228 1.254 2.367 2.307 3.42s2.192 1.817 3.42 2.307a.75.75 0 0 0 .759-.142l1.032-1.049a2.25 2.25 0 0 1 2.485-.516l1.954.782a2.25 2.25 0 0 1 1.454 2.181v1.119a2.25 2.25 0 0 1-2.25 2.25h-.75c-8.284 0-15-6.716-15-15v-.75Z" />
    </svg>
  );
}
...
export function HeartIcon({ className = "size-4", filled = false }: IconProps & { filled?: boolean }) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
      fill={filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth={filled ? 0 : 1.75}>
