...
export function ForbiddenPage() {
  ...
  return (
    ...
    >
      <div className="flex size-24 items-center justify-center rounded-3xl border border-red-900/40 bg-red-950/30">
        <svg className="size-12 text-red-400" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor">
